  ...
  return (
    <section className="relative min-h-[50vh] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0a1628]">
        <Image src={backgroundImage} alt="Notice Hero Background" fill className="object-cover" />
      ...
      <div className="relative z-10 px-8 lg:px-16 pt-20 pb-16 max-w-[1440px] mx-auto">
        <div className="max-w-4xl mx-auto">
          <motion.h1 
            className="text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-6 leading-tight text-center"
