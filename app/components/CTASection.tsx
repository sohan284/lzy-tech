...
export default function CTASection() {
  return (
    <section className="relative w-full min-h-[600px] md:min-h-[700px] lg:min-h-[80vh] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 ">
        ...
        <div className="absolute inset-0 bg-[#002FA7] opacity-50">
          {/* Subtle pattern overlay */}
        </div>
        {/* Responsive blue overlay shape */}
        <div className="absolute hidden lg:block w-[85vw] md:w-[75vw] lg:w-[70vw] h-full -left-20 md:-left-32 lg:-left-40 bg-primary/90 z-20 rounded-br-[60%] md:rounded-br-[70%] lg:rounded-br-[80%]"></div>
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20 xl:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center min-h-[500px] md:min-h-[600px]">
          ...
          <div className="text-white">
            ...
            >
              <span className="whitespace-nowrap">Echanger avec un expert IzyTechnology</span>
          ...
          <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center mt-8 lg:mt-0">
            {/* Placeholder for expert image - you can replace this */}
            <div className="relative w-full h-full max-w-md">
              {/* Expert Image */}
             

              {/* Contact Widget Overlay */}
              <div className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 bg-white rounded-lg p-4 sm:p-6 shadow-xl max-w-[240px] sm:max-w-[280px]">
