...
export default function FeatureCard({ icon, title, description }: FeatureCardProps) {
  return (
    <div className="group bg-white border border-gray-200 rounded-lg lg:p-16 p-5 hover:bg-primary hover:border-primary transition-all duration-300 cursor-pointer flex flex-col text-center">
      {/* Icon */}
